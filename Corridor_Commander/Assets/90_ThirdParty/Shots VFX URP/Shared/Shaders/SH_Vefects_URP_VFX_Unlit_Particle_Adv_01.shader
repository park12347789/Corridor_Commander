...
Shader "Vefects/SH_Vefects_URP_VFX_Unlit_Particle_Adv_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_output_43_0 = ( input.ase_color * _Tint );
				float2 texCoord18 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner25 = ( 1.0 * _Time.y * _UVPan + ( texCoord18 * _UVScale ));
				float2 texCoord10 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * _UVDPan + ( texCoord10 * _UVDScale ));
				...
				float4 temp_cast_0 = (input.ase_texcoord5.z).xxxx;
				float2 uv_CutoutTexture = input.ase_texcoord4.xy * _CutoutTexture_ST.xy + _CutoutTexture_ST.zw;
				float4 temp_cast_1 = (_CutoutPower).xxxx;
				float4 temp_output_45_0 = saturate( ( ( input.ase_color.a * saturate( ( ( tex2DNode27 - temp_cast_0 ) / _ErosionSmoothness ) ) ) * saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_1 ) * _CutoutMult ) ) ) );
				...
				float screenDepth58 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth58 = abs( ( screenDepth58 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( lerpResult60 * _EmissiveMult ).rgb;
				float Alpha = saturate( ( temp_output_45_0 * saturate( distanceDepth58 ) ) ).r;
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 panner25 = ( 1.0 * _Time.y * _UVPan + ( texCoord18 * _UVScale ));
				float2 texCoord10 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * _UVDPan + ( texCoord10 * _UVDScale ));
				float2 lerpResult24 = lerp( float2( 0,0 ) , ( ( (tex2D( _MainTexture1, panner14 )).rg + -0.5 ) * 2.0 ) , _UVDLerp);
				float4 tex2DNode27 = tex2D( _MainTexture, ( panner25 + lerpResult24 ) );
				float4 temp_cast_0 = (input.ase_texcoord4.z).xxxx;
				float2 uv_CutoutTexture = input.ase_texcoord3.xy * _CutoutTexture_ST.xy + _CutoutTexture_ST.zw;
				float4 temp_cast_1 = (_CutoutPower).xxxx;
				float4 temp_output_45_0 = saturate( ( ( input.ase_color.a * saturate( ( ( tex2DNode27 - temp_cast_0 ) / _ErosionSmoothness ) ) ) * saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_1 ) * _CutoutMult ) ) ) );
				float4 ase_positionSSNorm = ScreenPos / ScreenPos.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 texCoord18 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner25 = ( 1.0 * _Time.y * _UVPan + ( texCoord18 * _UVScale ));
				float2 texCoord10 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * _UVDPan + ( texCoord10 * _UVDScale ));
				float2 lerpResult24 = lerp( float2( 0,0 ) , ( ( (tex2D( _MainTexture1, panner14 )).rg + -0.5 ) * 2.0 ) , _UVDLerp);
				float4 tex2DNode27 = tex2D( _MainTexture, ( panner25 + lerpResult24 ) );
				float4 temp_cast_0 = (input.ase_texcoord1.z).xxxx;
				float2 uv_CutoutTexture = input.ase_texcoord.xy * _CutoutTexture_ST.xy + _CutoutTexture_ST.zw;
				float4 temp_cast_1 = (_CutoutPower).xxxx;
				float4 temp_output_45_0 = saturate( ( ( input.ase_color.a * saturate( ( ( tex2DNode27 - temp_cast_0 ) / _ErosionSmoothness ) ) ) * saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_1 ) * _CutoutMult ) ) ) );
				...
				surfaceDescription.Alpha = saturate( ( temp_output_45_0 * saturate( distanceDepth58 ) ) ).r;
		...
		Pass
		{
			...
			half4 frag(	PackedVaryings input  ) : SV_Target
			{
				...
				float2 texCoord18 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner25 = ( 1.0 * _Time.y * _UVPan + ( texCoord18 * _UVScale ));
				float2 texCoord10 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * _UVDPan + ( texCoord10 * _UVDScale ));
				float2 lerpResult24 = lerp( float2( 0,0 ) , ( ( (tex2D( _MainTexture1, panner14 )).rg + -0.5 ) * 2.0 ) , _UVDLerp);
				float4 tex2DNode27 = tex2D( _MainTexture, ( panner25 + lerpResult24 ) );
				float4 temp_cast_0 = (input.ase_texcoord3.z).xxxx;
				float2 uv_CutoutTexture = input.ase_texcoord2.xy * _CutoutTexture_ST.xy + _CutoutTexture_ST.zw;
				float4 temp_cast_1 = (_CutoutPower).xxxx;
				float4 temp_output_45_0 = saturate( ( ( input.ase_color.a * saturate( ( ( tex2DNode27 - temp_cast_0 ) / _ErosionSmoothness ) ) ) * saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_1 ) * _CutoutMult ) ) ) );
...
Node;AmplifyShaderEditor.Vector2Node;11;-4650.514,1024.215;Inherit;False;Property;_UVDScale;UVD Scale;9;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;12;-4394.514,1024.215;Inherit;False;Property;_UVDPan;UVD Pan;8;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;15;-4138.513,896.2147;Inherit;True;Property;_MainTexture1;UVD Tex;7;0;Create;True;0;0;0;False;3;Space(33);Header(Distortion Texture);Space(33);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.Vector2Node;16;-4650.514,640.2148;Inherit;False;Property;_UVScale;UV Scale;5;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;21;-4394.514,640.2148;Inherit;False;Property;_UVPan;UV Pan;4;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;22;-2986.512,896.2147;Inherit;False;Property;_UVDLerp;UVD Lerp;10;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;27;-2602.512,512.2148;Inherit;True;Property;_MainTexture;Main Texture;1;0;Create;True;0;0;0;False;3;Space(13);Header(Main Texture);Space(33);False;-1;None;4f93d5af23962794b8bacfaac079d9b8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;29;-1450.513,896.2147;Inherit;True;Property;_CutoutTexture;Cutout Texture;11;0;Create;True;0;0;0;False;3;Space(33);Header(Cutout);Space(33);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;30;-1066.512,1024.215;Inherit;False;Property;_CutoutPower;Cutout Power;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-1962.513,1024.215;Inherit;False;Property;_ErosionSmoothness;Erosion Smoothness;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-810.5125,1024.215;Inherit;False;Property;_CutoutMult;Cutout Mult;13;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-1418.513,1984.215;Inherit;False;Property;_DepthFade;Depth Fade;19;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;507.2599,79.68589;Inherit;False;Property;_Cull1;Cull;14;0;Create;True;0;0;0;True;3;Space(13);Header(AR);Space(13);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;763.2599,79.68589;Inherit;False;Property;_Src1;Src;15;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;1019.26,79.68589;Inherit;False;Property;_Dst1;Dst;16;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;1531.26,79.68589;Inherit;False;Property;_ZTest1;ZTest;18;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;1275.26,79.68589;Inherit;False;Property;_ZWrite1;ZWrite;17;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;40;-2602.512,-127.7851;Inherit;False;Property;_Tint;Tint;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-810.5125,256.2148;Inherit;False;Property;_RealColor;Real Color;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-426.5126,-127.7851;Inherit;False;Property;_EmissiveMult;Emissive Mult;0;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_VFX_Unlit_Particle_Adv_01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;9;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull1;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;2;5;True;_Src1;10;True;_Dst1;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite1;True;3;True;_ZTest1;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;27;Surface;1;638255503152939265;  Blend;0;0;Two Sided;1;0;Alpha Clipping;0;638722247873705702;  Use Shadow Threshold;0;0;Forward Only;0;0;Cast Shadows;1;0;Receive Shadows;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;True;True;False;False;True;True;True;False;True;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;63;0,100;Float;False;False;-1;3;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;1;3;56;0
ASEEND*/
//CHKSM=06D68051EA6E98306EA0FCEBB3125F90EC8252E1